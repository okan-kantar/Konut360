...
import { z } from "zod";
import { changeAidatStatus } from "@/lib/services/changeAidatStatus";
...
export async function POST(
  ...
  try {
    ...
    const kayit = await changeAidatStatus({
    ...
    return NextResponse.json({ id: String(kayit._id), durum: kayit.durum, hesaplananFaiz: kayit.hesaplananFaiz });
  } catch (error) {
